...
export const constantRouterMap = [{
    ...
    },
    {
        ...
        children: [{
            ...
            },
            {
                ...
                meta: { title: '查看商品详情', icon: 'product-add' },
                hidden: true
            },
            {
                path: 'productRecycle',
            ...
            },
            {
                ...
                meta: { title: '1号专区管理', icon: 'product-cate' }
            },
            {
                path: 'addProductCate',
                name: 'addProductCate',
    ...
    },
    {
        ...
        children: [{
                ...
                meta: { title: '匀贸订单', icon: 'product-list' }
            },
            {
                path: 'orderDetail',
                name: 'orderDetail',
            ...
            },
            {
                ...
                meta: { title: '订单详情', icon: 'order-setting' }
            },
            {
                path: 'orderNum',
                name: 'orderNum',
                component: () =>
                    import ('@/views/oms/order/orderNum'),
                meta: { title: '订单详情', icon: 'order-setting' }
            },
            {
                path: 'returnApply',
    ...
    },
    {
        path: '/sms',
        component: Layout,
        redirect: '/sms/homeAdvertise',
        name: 'sms',
        meta: { title: '店铺', icon: 'sms' },
        children: [{
                path: 'flash',
                name: 'flash',
                component: () =>
                    import ('@/views/sms/flash/index'),
                meta: { title: '店铺管理2', icon: 'sms-flash' }
            },
            {
                path: 'homeAdvertise',
                name: 'homeAdvertise',
            ...
            },
            {
                ...
                meta: { title: '店铺订单明细', icon: 'sms-new' }
            },
            {
            ...
            },
            {
                ...
                meta: { title: '商户打款结算记录', icon: 'sms-hot' }
            },
            {
                path: 'flashSession',
                name: 'flashSession',
            ...
            },
            {
                ...
                name: 'redPacket',
                component: () =>
                    import ('@/views/sms/redPacket/index'),
...

            {
                ...
                name: 'addRedPacket',
                component: () =>
                    import ('@/views/sms/redPacket/add'),
                meta: { title: '添加红包' },
                hidden: true
            },
            {
                ...
                component: () =>
                    import ('@/views/sms/redPacket/update'),
                meta: { title: '编辑红包' },
                hidden: true
            }
        ]
    },
    {
        ...
        children: [{
            ...
            },
            {
                ...
                name: 'updateMember',
                component: () =>
                    import ('@/views/ums/member/update'),
                meta: { title: '编辑会员' },
                hidden: true
            }, {
                path: 'memberLevel',
                name: 'memberLevel',
                component: () =>
                    import ('@/views/ums/memberLevel/index'),
                meta: { title: '代理分润/条件查询', icon: 'product-list' }
            },

            {
                ...
                name: 'addMemberLevel',
                component: () =>
                    import ('@/views/ums/memberLevel/add'),
                meta: { title: '添加会员等级' },
                hidden: true
            },
            {
                ...
                component: () =>
                    import ('@/views/ums/memberLevel/update'),
                meta: { title: '编辑会员等级' },
                hidden: true
            }, {
                path: 'school',
                name: 'school',
                component: () =>
                    import ('@/views/ums/school/index'),
                meta: { title: '会员资产', icon: 'product-list' }
            },
            ...
            },
            {
                ...
                name: 'updateSchool',
                component: () =>
                    import ('@/views/ums/school/update'),
                meta: { title: '编辑学校' },
                hidden: true
            }, {
                ...
                component: () =>
                    import ('@/views/ums/memberBlanceLog/index'),
                meta: { title: '代理分润查询（往期）', icon: 'product-list' }
            }
    ...
    },
    {
        ...
        children: [{
            ...
            },
            {
                ...
                name: 'addPermission',
                component: () =>
                    import ('@/views/sys/permission/add'),
                meta: { title: '添加权限' },
                hidden: true
            },
            {
                ...
                component: () =>
                    import ('@/views/sys/permission/update'),
                meta: { title: '编辑权限' },
                hidden: true
            },
            {
            ...
            },
            {
                ...
                name: 'webLog',
                component: () =>
                    import ('@/views/sys/webLog/index'),
                meta: { title: '前台日志列表', icon: 'product-list' }
            }, {
                path: 'adminLog',
                name: 'adminLog',
                component: () =>
                    import ('@/views/sys/adminLog/index'),
    ...
    },
    {
        ...
        redirect: '/cms/help',
        name: 'cms',
        meta: { title: '运营', icon: 'home' },
        children: [{
                path: 'help',
                name: 'help',
                component: () =>
                    import ('@/views/cms/help/index'),
                meta: { title: '下级及消费管理', icon: 'product-list' }
            }, {
                path: 'addHelp',
                name: 'addHelp',
                component: () =>
                    import ('@/views/cms/help/add'),
                meta: { title: '添加帮助' },
                hidden: true
            },
            {
            ...
            },
            {
                ...
                name: 'subject',
                component: () =>
                    import ('@/views/cms/subject/index'),
                meta: { title: '专题列表', icon: 'product-list' }
            }, {
                path: 'addSubject',
                name: 'addSubject',
                component: () =>
                    import ('@/views/cms/subject/add'),
                meta: { title: '添加专题' },
                hidden: true
            },
            {
                ...
                name: 'updateSubject',
                component: () =>
                    import ('@/views/cms/subject/update'),
                meta: { title: '编辑专题' },
                hidden: true
            },
            {
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/cms/helpCategory/update'),
                meta: { title: '编辑专题分类' },
                hidden: true
            },
            {
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/cms/memberReport/update'),
                meta: { title: '编辑权限' },
                hidden: true
            },
            {
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/cms/prefrenceArea/update'),
                meta: { title: '编辑偏爱专区' },
                hidden: true
            }
            ...
            ,
            {
                ...
                component: () =>
                    import ('@/views/cms/subjectCategory/index'),
                meta: { title: '帮助列表', icon: 'product-list' }
            }, {
                path: 'addSubjectCategory',
                name: 'addSubjectCategory',
                component: () =>
                    import ('@/views/cms/subjectCategory/add'),
                meta: { title: '添加权限' },
                hidden: true
            },
            {
                ...
                component: () =>
                    import ('@/views/cms/subjectCategory/update'),
                meta: { title: '编辑权限' },
                hidden: true
            }
            ...
            ,
            {
                ...
                name: 'subjectComment',
                component: () =>
                    import ('@/views/cms/subjectComment/index'),
                meta: { title: '帮助列表', icon: 'product-list' }
            }, {
                path: 'addSubjectComment',
                name: 'addSubjectComment',
                component: () =>
                    import ('@/views/cms/subjectComment/add'),
                meta: { title: '添加权限' },
                hidden: true
            },
            {
                ...
                component: () =>
                    import ('@/views/cms/subjectComment/update'),
                meta: { title: '编辑权限' },
                hidden: true
            }
            ...
            , {
                ...
                name: 'topic',
                component: () =>
                    import ('@/views/cms/topic/index'),
                meta: { title: '帮助列表', icon: 'product-list' }
            }, {
                path: 'addTopic',
                name: 'addTopic',
                component: () =>
                    import ('@/views/cms/topic/add'),
                meta: { title: '添加权限' },
                hidden: true
            },
            {
            ...
            , {
                ...
                name: 'topicCategory',
                component: () =>
                    import ('@/views/cms/topicCategory/index'),
                meta: { title: '帮助列表', icon: 'product-list' }
            }, {
                path: 'addTopicCategory',
                name: 'addTopicCategory',
                component: () =>
                    import ('@/views/cms/topicCategory/add'),
                meta: { title: '添加权限' },
                hidden: true
            },
            {
                ...
                component: () =>
                    import ('@/views/cms/topicCategory/update'),
                meta: { title: '编辑权限' },
                hidden: true
            }
            ...
            , {
                ...
                name: 'topicComment',
                component: () =>
                    import ('@/views/cms/topicComment/index'),
                meta: { title: '帮助列表', icon: 'product-list' }
            }
        ]
    },
    {
        path: '/jctj',
        component: Layout,
        redirect: '/jctj/realStatistics',
        name: 'jctj',
        meta: { title: '运营数据统计', icon: 'product' },
        children: [{
                path: 'realStatistics',
                name: 'realStatistics',
                component: () =>
                    import ('@/views/jctj/realStatistics'),
                meta: { title: '实时统计', icon: 'product-list' }
            },
            {
                path: 'geographical',
                name: 'geographical',
                component: () =>
                    import ('@/views/jctj/geographical'),
                meta: { title: '地域分布', icon: 'product-list' },
                hidden: true
            },
            // {
            //     path: 'channelOverview',
            //     name: 'channelOverview',
            //     component: () =>
            //         import ('@/views/jctj/channelOverview'),
            //     meta: { title: '渠道概况', icon: 'product-list' },
            //     hidden: true
            // },
            {
                path: 'commodityRevenue',
                name: 'commodityRevenue',
                component: () =>
                    import ('@/views/jctj/commodityRevenue'),
                meta: { title: '商品&营收数据概览', icon: 'product-list' },
                hidden: true
            },
        ]
    },
