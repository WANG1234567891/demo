  ...
  <div style="margin-top: 50px">
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button v-if="!isEdit" @click="resetForm('roleFrom')"
          >重置</el-button
        >
      </el-form-item>
    </el-form>
...
import { fetchList } from "@/api/sys/permission";
...
export default {
  ...
  data() {
    return {
      ...
      menuIds: null,
      rules: {
        name: [{ required: true, message: "请输入角色明", trigger: "blur" }],
      },
       defaultProps: {
          children: 'childrens',
          label: 'name'
  ...
  methods: {
    getMenuList() {
      fetchList().then((response) => {
        this.subjectList = treeDataTranslate(response.data, 'id',"pid");
